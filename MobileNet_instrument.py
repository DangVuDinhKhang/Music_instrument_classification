...
checkpoint = ModelCheckpoint(
    monitor = "val_loss",
    filepath = "MobileNetFinal.{epoch:02d}-{loss:.4f}-{accuracy:.4f}-{val_loss:.4f}-{val_accuracy:.4f}.hdf5",
    verbose = 1,
    save_best_only = True, 
...
model.load_weights("./MobileNetFinal.34-0.2131-0.9263-0.1330-0.9547.hdf5")
