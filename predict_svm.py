...
loaded_model = joblib.load("svm_model_0.9667.pkl")
...
def predict_image(image_data):
    ...
    y_inception = inceptionV3_model.predict(image)
    y_resnet50 = resnet50_model.predict(image)
    y_resnet101 = resnet101_model.predict(image)
    y_vgg16 = vgg16_model.predict(image)
    y_vgg19 = vgg19_model.predict(image)
    y_densenet121 = densenet121_model.predict(image)
    y_combined = np.hstack((y_mobileNet, y_inception, y_resnet50, y_resnet101, y_vgg16, y_vgg19, y_densenet121))
