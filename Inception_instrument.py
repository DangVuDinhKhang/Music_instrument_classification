...
checkpoint = ModelCheckpoint(
    monitor = "val_loss",
    filepath = "InceptionV3N.{epoch:02d}-{loss:.4f}-{accuracy:.4f}-{val_loss:.4f}-{val_accuracy:.4f}.hdf5",
    verbose = 1,
    save_best_only = True, 
...
model.load_weights("./InceptionV3N.99-0.5046-0.8429-0.2890-0.9187.hdf5")
